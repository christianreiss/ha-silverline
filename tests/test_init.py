...
async def test_firmware_capability_filter_skips_missing_dps(
    ...
    temperature number, 1 fault-code sensor, and 5 fault binary sensors —
    and nothing else. The 10 diagnostic temperature/frequency/eev/fan
    sensors and the water-pump binary sensor (DPs 101-111) must NOT
    register."""
