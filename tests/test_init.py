...
async def test_firmware_capability_filter_skips_missing_dps(
    ...
    PC-SLP090N) should produce: 1 climate, 1 target_temperature number,
    1 fault-code sensor, and 5 fault binary sensors — and nothing else.
    The 10 diagnostic temperature/frequency/eev/fan sensors and the
